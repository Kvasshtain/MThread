...
#define BitBangSram(Addr, BitNumber, data) \
	(*(uint32_t *) (SRAM_BB_BASE | ((Addr - SRAM_BASE) << 5) | ((BitNumber) << 2)) = data)

#define PERIPH_BASE                 0x40000000
#define PERIPH_BB_BASE              0x42000000
#define BitBangPeripheral(Addr, BitNumber, data) \
	(*(uint32_t *) (PERIPH_BB_BASE | ((Addr - PERIPH_BASE) << 5) | ((BitNumber) << 2)) = data)
//---------------------------------------------------------------------------------------------------	
...
/*-- MDR32Fx specific Interrupt Numbers --------------------------------------*/
  ...
  S_UART_IRQn             =  23,  /*!< Soft_UART Interrupt      !!!!!!        */
